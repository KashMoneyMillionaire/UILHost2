...
public static partial class MVC
{
    ...
    public static UILHost.Web.Controllers.ManageController Manage = new UILHost.Web.Controllers.T4MVC_ManageController();
    public static UILHost.Web.Controllers.MeetController Meet = new UILHost.Web.Controllers.T4MVC_MeetController();
    public static UILHost.Web.Controllers.StudentController Student = new UILHost.Web.Controllers.T4MVC_StudentController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string ai_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/ai.min.js") ? Url("ai.min.js") : Url("ai.js");
        ...
        public static class MultiSelect {
            private const string URLPATH = "~/Scripts/MultiSelect";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
    ...
    public static class Content {
        ...
        public static readonly string fancy_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/fancy.min.css") ? Url("fancy.min.css") : Url("fancy.css");
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class MultiSelect {
            private const string URLPATH = "~/Content/MultiSelect";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
