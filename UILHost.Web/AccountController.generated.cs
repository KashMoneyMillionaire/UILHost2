...
namespace UILHost.Web.Controllers
{
    public partial class AccountController
    {
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string RegisterSchool = "RegisterSchool";
        ...
        public class ActionNameConstants
        {
            ...
            public const string RegisterSchool = "RegisterSchool";
        ...
        static readonly ActionParamsClass_RegisterSchool s_params_RegisterSchool = new ActionParamsClass_RegisterSchool();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_RegisterSchool RegisterSchoolParams { get { return s_params_RegisterSchool; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_RegisterSchool
        {
            public readonly string model = "model";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string RegisterSchool = "~/Views/Account/RegisterSchool.cshtml";
    ...
    public partial class T4MVC_AccountController : UILHost.Web.Controllers.AccountController
    {
        ...
        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Login(UILHost.Web.Models.LoginViewModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        [NonAction]
        partial void RegisterSchoolOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult RegisterSchool()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.RegisterSchool);
            RegisterSchoolOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void RegisterSchoolOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, UILHost.Web.Models.RegisterSchoolViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> RegisterSchool(UILHost.Web.Models.RegisterSchoolViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.RegisterSchool);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            RegisterSchoolOverride(callInfo, model);
            return System.Threading.Tasks.Task.FromResult(callInfo as ActionResult);
        }
        ...
        [NonAction]
        partial void ForgotPasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, UILHost.Web.Models.ForgotPasswordViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ForgotPassword(UILHost.Web.Models.ForgotPasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ForgotPassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ResetPasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, UILHost.Web.Models.ResetPasswordViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ResetPassword(UILHost.Web.Models.ResetPasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ResetPassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
