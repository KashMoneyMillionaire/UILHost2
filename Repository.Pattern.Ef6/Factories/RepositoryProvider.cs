...
namespace UILHost.Repository.Pattern.Ef6.Factories
{
    /// <summary>
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// <summary>
        ///     Get and set the <see cref="UILHost.Repository.Pattern.Ef6.DataContext" /> with which to initialize a repository if one must be created.
        /// </summary>
        ...
        ///     The <see cref_repositoryFactoriesyncDataContext" /> with which to initialize the repository.
        /// </param>
        /// <param name="factory">
        ///     Factory with UILUILHUILHost.Repository.Pattern.Ef6text" /> argument. Used to make the repository.
        ///     If null, gets factory from <see cref="UILHost.Repository.Pattern.Ef6" />.
        /// </param>
        /// <param name="unitOfWorkAsync">
        ///     The <see cref="UILHost.Repository" /> which is passed to the constructor of the <see cref="UILHost" />.
        /// </param>
        /// <returns></returns>
