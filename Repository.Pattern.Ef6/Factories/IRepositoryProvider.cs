...
namespace Repository.Pattern.Ef6.Factories
{
    ...
    /// </summary>
    /// <remarks>
    ///     Repositories created by this provider tend to require a <see cref="UILHost.Repository.Pattern.Ef6.DataContext" />
    ///     to retrieve data.
    /// </remarks>
    public interface IRepositoryProvider
    {
        ...
        /// </typeparam>
        /// <param name="factory">
        ///     An optional repository creation function that takes a <see cref="UILHost.Repository.Pattern.Ef6.DataContext" />
